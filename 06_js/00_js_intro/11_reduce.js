...
// map은 배열의 각 요소를 변형한다면, reduce는 배열 전체(자체)를 변형한다.
...
//  두번째 매개 변수는 현재 배열 요소, 현재 인덱스, 배열 자체 순이다. === x
//  초기값 === 0( 첫 total 값) ==> 생략되면, 배열의 첫번째 요소가 초기값이 된다. 

// 4- 1 연습
// 다음 배열 내의 요소의 총합을 구하시오.
const arr = [0, 1, 2, 3]

const sum2 = arr.reduce((total, x) => total += x)
console.log(sum2)
