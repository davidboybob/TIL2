...
4
"""
numbers = len(ssafy.get('location'))
print(numbers)
...
# print(ssafy.get('language').keys())

for num in ssafy.get('language').keys():
    print(num)
...
for manager in ssafy.get('classes').get('gj').values():
    print(manager)
...
for platform , function in ssafy.get('language').get('python').get('frameworks').items():
    print(f'{platform}는 {function}이다.')
